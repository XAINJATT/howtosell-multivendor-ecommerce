                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <div>
                                        <h5 class="mb-3 mb-md-0">Products > <span class="text-secondary">Create Product</span></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter Name" name="price" id="price" required>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <label for="discounted_price" class="font-weight-bold">Discounted Price <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" placeholder="Enter Name" name="discounted_price" id="discounted_price" required>
                                        </div>
