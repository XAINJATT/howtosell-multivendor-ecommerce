                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <div>
                                        <h5 class="mb-3 mb-md-0">Companies > <span class="text-secondary">Edit Company</span></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-2">
                                            <label for="image" class="font-weight-bold">Image <span
                                                ...
                                                <a href="{{asset('public/storage/company' . '/' . $company->image)}}"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Company Home Page Link" value="{{$company->link}}"
